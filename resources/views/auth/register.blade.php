        ...
        <div class="w-full md:w-2/3 lg:w-1/2">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg rounded-xl border border-gray-100 dark:border-gray-700">
                <div class="bg-gradient-to-r from-blue-600 to-indigo-700 p-6 text-white">
                    <h2 class="text-2xl font-bold">{{ __('Buat Akun Baru') }}</h2>
                    <p class="text-blue-100 mt-2">Mulai kelola keuangan Anda dengan CatatKeuangan</p>
                </div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                ...
                                <input id="password-confirm" type="password" class="pl-10 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" name="password_confirmation" required autocomplete="new-password" placeholder="Ulangi kata sandi">
                            </div>
                        </div>

                        <div class="mb-6">
                            <div class="flex items-center">
                                <input class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" type="checkbox" name="agree_terms" id="agree_terms" required>
                                <label class="ml-2 block text-sm text-gray-700 dark:text-gray-300" for="agree_terms">
                                    {{ __('Saya setuju dengan') }} <a href="#" class="text-blue-600 hover:text-blue-500">Syarat dan Ketentuan</a>
                                </label>
                            </div>
                        </div>
